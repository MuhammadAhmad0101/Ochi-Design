const Footer = () => {
      return (
            <div className="w-full flex pt-16 pb-8 px-12  bg-[#F4F4F4] h-[130vh]">
                  <div className="w-1/2 flex flex-col justify-between h-full">
                        <h1 className="font-bold font-Robot w-1/2 text-8xl leading-none tracking-tighter uppercase">eye-opening</h1>
                        <div className="">
                  ...
                  <div className="w-1/2 h-full">
                        <div className="grid grid-cols-5 grid-rows-7">
                              <div className="col-span-5 row-span-2">
                                    <h1 className="text-[5.4rem] font-Robot font-bold tracking-tighter leading-none uppercase">presentations</h1>
                              </div>
                              <div className="col-span-2 row-span-5 row-start-3">
                                    <div>
                                          S:
                                          <p className="underline mt-1">Instagram</p>
                                          <p className="underline"> Behance</p> <p className="underline">Facebook</p> <p className="underline">Linkedin</p>
                                    </div>
                                    <div className="mt-10">
                                          L:
                                          <p className="underline mt-5">202-1965 W 4th Ave</p>
                                    ...
                                    <div className="mt-10">
                                          ...
                                          <p className="opacity-50 text-nowrap mt-10">
                                                © ochi design 2024. <span className="underline"> Legal Terms</span>
                                          </p>
                                    </div>
                              </div>
                              <div className="col-span-2 row-span-5 col-start-4 row-start-5">
                                    M:
                                    {["Home", "Services", "Our work", "About us", "Insights", "Contact us"].map((item, index) => (
                                          <p key={index} className={`${!index && "mt-5"} underline `}>
                                                {item}
                                          </p>
                                    ))}
                                    <p className="underline mt-14 opacity-50">Website by Ahmad</p>
                              </div>
                        </div>
                  </div>
            </div>
