export const Navbar = () => {
      return (
            <div className="w-full flex px-12 py-4 bg-[#F1F1F1] justify-between items-center">
                  ...
                  <div className="flex items-center gap-5 text-[#212121] w-[50%] justify-end">
                        {["Services", "Our work", "About us", "Insights"].map((navLink, index) => {
                              return (
                                    <h1 className=" font-medium text-[#212121] cursor-pointer" key={index}>
                                          {navLink}
                                    </h1>
                              );
                        })}
                  ...
                  <div>
                        <h1 className="mr-3 leading-none font-medium text-[#212121] cursor-pointer ">Contact us</h1>
                  </div>
            </div>
      );
};
